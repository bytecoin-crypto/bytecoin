...
const char * const BITCOIN_CONF_FILENAME = "bytecoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Bytecoin
    // macOS: ~/Library/Application Support/Bytecoin
    // Unix-like: ~/.bytecoin
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Bytecoin";
#else
    // Unix-like
