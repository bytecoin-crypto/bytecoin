...
{
    switch (unit) {
    case Unit::BTC: return QString("BTE");
    case Unit::mBTC: return QString("mBTE");
    case Unit::uBTC: return QString::fromUtf8("µBTE (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Bytecoins");
    case Unit::mBTC: return QString("Milli-Bytecoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Bytecoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
